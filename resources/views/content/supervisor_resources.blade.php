<x-guest-layout>
    ...
    <div class="p-3">
        <ul>
            ...
            <x-li-dot class="bg-nw-blue-500">Co-supervision / Mentoring (subject to collaboration agreement / funding)</x-li-dot>
            <x-li-dot class="bg-nw-blue-500">Co-development of learning and teaching resources or data set publication</x-li-dot>
            <x-li-dot class="bg-nw-blue-500">Support in the understanding of FAIR data and access to our Electronic Research Notebook (ERN)</x-li-dot>
            <x-li-dot class="bg-nw-blue-500"> Hypothesis and Idea generation (link to student project ideas document)</x-li-dot>
        </ul>
        <br>
</div>
