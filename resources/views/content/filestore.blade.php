<x-guest-layout>
    ...
    <div class="p-3">
        <p>Information and data summary files that are not available on the Data Portal can be directly 
        downloaded from the Farm Platform file store and includes:</p><br>
