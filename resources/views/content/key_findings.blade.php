<x-guest-layout>
    ...
    <div class="grid-col-1 grid gap-4 p-3 lg:grid-cols-2">
        ...
        <div class="rounded-lg border-2 border-nw-blue-700 shadow-sm">
            ...
            <div class="pt-5 pl-5 pr-5 "><img class="mx-auto" src="/images/Fig1a.png"
    ...
    <div class="grid-col-1 grid gap-4 p-3 lg:grid-cols-2">
        <div class="rounded-lg border-2 border-nw-blue-700 shadow-sm">
            ...
            <img class="mx-auto" src="/images/Fig3a.png" alt="Carbon footprints of individual cattle and their
                        growth performances" />
            <div class="p-3">
        ...
        <div class="rounded-lg border-2 border-nw-blue-700 shadow-sm">
            ...
            <img class="mx-auto" src="/images/Fig3b.png" alt="Carbon footprint of grass-fed beef and free-range
